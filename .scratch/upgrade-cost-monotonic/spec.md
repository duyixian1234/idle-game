...
> **⚠️ 部分推翻（2026-08-08，[ADR-0036](../../docs/adr/0036-ordinary-building-no-upgrade.md)）**：本 spec 的"普通建筑升级成本"段（含 `× buildingCount`）已失效——7 个普通可多次购买建筑的升级能力被砍除，产出回归 `produces×count`。唯一建筑/船坞/科技的成本曲线段仍有效。普通建筑升级单调性测试随升级取消而废弃。
